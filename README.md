...
### 2. 📶 Wireless AP Lifecycle (UNC2)
**Goal:** To bring Amazon Fresh Hub/Whole Foods site UNC2 to compliance with 2020 Enterprise initiative to move from Cisco Flex to Juniper Mist<br>
<br>
**Highlights:**
- Replaced all the WAPs from Cisco previous solution to new Juniper Mist infrastructure.  
- CMs performed for Routers / Switch / WLC / Firewall configuration upgrades.  
- Backend induction of site via AWS Cloud   
...
| Requirements       | Tech / Purpose                              |
|------------|--------------------------------------|
| LVC Colaboration    | Installation of network drops / consult of unusal AP placements / brackets          |
| AWS Cloud | Backend Site Adoption         |
| OSHA Safety Standards/Certification  | Proper safety training/equipment required for work on active construction site          |
| Various CMs pre and post conversion | Scheduling site downtime, initiating network configuration upgrades, building access                      |

<br> 
<p float="center">
  <img src="images/FreezerFloor.png" width="200" />
  <img src="images/FreezerFloor2.png" width="200" />
  <img src="images/Fluke2.png" width="200" />
